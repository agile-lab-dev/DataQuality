...
object MetricMapper extends Enumeration {
  ...
  val sumOfDecimalValues = MetricDefinition("SUM_DECIMAL_NUMBER", classOf[SumDecimalValueMetricCalculator])
  val meanNumeric = MetricDefinition("AVG_NUMBER",classOf[StdAvgNumericValueCalculator])
  val meanDecimal = MetricDefinition("AVG_DECIMAL_NUMBER",classOf[StdAvgDecimalValueCalculator])
  val stdDeviation = MetricDefinition("STD_NUMBER", classOf[StdAvgNumericValueCalculator])
  val stdDeviationDecimal = MetricDefinition("STD_DECIMAL_NUMBER", classOf[StdAvgDecimalValueCalculator])
